...
class TestUserregistration():
  ...
  def test_userregistration(self):
    ...
    self.driver.find_element(By.ID, "id_registration-email").send_keys("mail71114@mail.com")
    self.driver.find_element(By.ID, "id_registration-password1").click()
    self.driver.find_element(By.ID, "id_registration-password1").send_keys("21071976#ED2ws")
    self.driver.find_element(By.ID, "id_registration-password2").click()
    self.driver.find_element(By.ID, "id_registration-password2").send_keys("21071976#ED2ws")
