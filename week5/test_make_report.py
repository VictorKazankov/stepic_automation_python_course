from week5.helpers import create_user_data, fill_field
from week5.locators import EMAIL_REGISTRATION_FIELD_ID, \
...
def test_user_registration_with_correct_data(browser):
    ...
    welcome_text = browser.find_element_by_class_name(CONFIRM_REGISTRATION_ALERT_NAME).text
    assert 'Thanks for registering!' in welcome_text
